...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/CFPressHoldButton/CFPressHoldButton.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/KnobGestureRecognizer/KnobGestureRecognizer.framework"
